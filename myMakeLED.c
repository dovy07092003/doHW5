...
*    
*    This program uses USR LED 3 and can be executed:
*        makeLED on
*        makeLED off
*        makeLED flash  (flash at 2000ms intervals - on 1000ms/off 1000ms)
*        makeLED status
*If the user enter invalid command, the LED will flash at a rate of 1s on, 1s off
